dir_r_scripts <- getwd()  # My code: assumes you're running from CAMELS-Attributes folder
...
### GLHYPMS
fgdb <- '../dataverse_files/GLHYMPS.gdb/'
...
### LiMW
fgdb <- '../dataverse_files/LiMW_GIS_2015.gdb/'
